"""
Test imports from main.py step by step
"""
from fastapi import FastAPI
from fastapi.middleware.cors import CORSMiddleware
import os

app = FastAPI(title="Import Test API", version="1.0.0")
...
@app.get("/")
async def root():
    return {"message": "Import Test API is running!", "status": "healthy"}
...
async def test_imports():
    ...
    try:
        ...
        results["fastapi_imports"] = "✅ Success"
    except Exception as e:
        results["fastapi_imports"] = f"❌ {str(e)}"
    
    try:
        from fastapi.middleware.cors import CORSMiddleware
        results["cors_middleware"] = "✅ Success"
    except Exception as e:
        results["cors_middleware"] = f"❌ {str(e)}"
    ...
    try:
        ...
        results["dotenv"] = "✅ Success"
    except Exception as e:
        results["dotenv"] = f"❌ {str(e)}"
